...
def get_action(task_id, code_snippet):
    prompts = {
        "bug_detection": f"Find the bug in this Python code. Return ONLY JSON: {{\"has_bug\": true, \"line_number\": 4}}\nCode:\n{code_snippet}",
        "bug_classification": f"Classify the bug in this Python code. Return ONLY JSON: {{\"bug_type\": \"logic\", \"severity\": \"high\", \"line_number\": 4, \"explanation\": \"infinite recursion bug\"}}\nCode:\n{code_snippet}",
        "code_fix": f"Fix the bug in this Python code. Return ONLY JSON: {{\"fixed_code\": \"def factorial(n):\\n    if n == 0:\\n        return 1\\n    return n * factorial(n - 1)\", \"explanation\": \"fixed recursive call\"}}\nCode:\n{code_snippet}"
    }
    try:
        completion = client.chat.completions.create(
            model=MODEL_NAME,
            messages=[
                {"role": "system", "content": "You are a Python code reviewer. Return only valid JSON."},
        ...
        defaults = {
            ...
            "bug_classification": {"bug_type": "logic", "severity": "high", "line_number": 4, "explanation": "bug found"},
            "code_fix": {"fixed_code": "def factorial(n):\n    if n == 0:\n        return 1\n    return n * factorial(n - 1)\n", "explanation": "fixed recursive call"}
        }
